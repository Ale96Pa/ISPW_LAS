...
<jsp:setProperty name="beanConsultaAule" property="*"/>

<%
    if (request.getParameter("consultazione") != null) {
        if (beanConsultaAule.getAnno() < 2000 || beanConsultaAule.getAnno() > 2100) {
        %> <jsp:forward page="errorAnnoConsultazione.jsp" /> <%
    }
    if (beanConsultaAule.getOrainizio() >= beanConsultaAule.getOrafine()){
        %> <jsp:forward page="errorOraConsultazione.jsp" /> <%
    }
        %> <jsp:forward page="mostraConsultazione.jsp" /> <%
    }
%>
...
<html>
<head>
    <title>Consulta aule disponibili</title>
</head>

<body bgcolor="#e0ffff" >
<h2>Consultazione di aule disponibili </h2>
<img src="logo.png" width="150" height="150" align="" hspace="1100">
<br>
<form method="get" action="insertConsultazione.jsp">
    ...
    <input name="consultazione" type="submit" id="consultazione" value="Consulta" class="btn btn-info">
